 ...
 */
class getAllergieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AllergieRepository' shared autowired service.
     *
     * @return \App\Repository\AllergieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AllergieRepository.php';

        return $container->privates['App\\Repository\\AllergieRepository'] = new \App\Repository\AllergieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
