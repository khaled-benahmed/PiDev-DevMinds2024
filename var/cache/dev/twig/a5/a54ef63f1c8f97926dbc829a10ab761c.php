...
class __TwigTemplate_c36a56422b7d70950391069cbcb3fe9a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "calendar/form.html.twig", ["button_label" => "Update"]);
        echo "
...
{% block body %}
    ...
    {{ include('calendar/form.html.twig', {'button_label': 'Update'}) }}
