...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <h1 class=\"mb-4 text-white\">Reclamation Index</h1>
        ...
        <div class=\"card\">
            <div class=\"card-body\">
                ";
        // line 17
        if ((twig_length_filter($this->env, (isset($context["reclamations"]) || array_key_exists("reclamations", $context) ? $context["reclamations"] : (function () { throw new RuntimeError('Variable "reclamations" does not exist.', 17, $this->source); })())) > 0)) {
            // line 18
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["reclamation"]) {
                ...
                echo "</td>
                                    <td>";
                // line 32
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "NomUserReclamation", [], "any", false, false, false, 32), "html", null, true);
                echo "</td>
                                    <td>";
                // line 33
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "textReclamation", [], "any", false, false, false, 33), "html", null, true);
                echo "</td>
                                    <td>";
                // line 34
                ((twig_get_attribute($this->env, $this->source, $context["reclamation"], "dateReclamation", [], "any", false, false, false, 34)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reclamation"], "dateReclamation", [], "any", false, false, false, 34), "Y-m-d"), "html", null, true))) : (print ("")));
                echo "</td>
                                    <td>
                                        <a href=\"";
                // line 36
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_show", ["id" => twig_get_attribute($this->env, $this->source, $context["reclamation"], "id", [], "any", false, false, false, 36)]), "html", null, true);
                ...
                echo "\" class=\"btn btn-sm btn-warning\">Edit</a>
                                        <a href=\"";
                // line 38
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reponse_show", ["id" => twig_get_attribute($this->env, $this->source, $context["reclamation"], "id", [], "any", false, false, false, 38)]), "html", null, true);
                echo "\" class=\"btn btn-sm btn-primary mr-2\">Show response</a>
                                    </td>
                                </tr>
                            ";
            }
...
";
    ...
    {
        return array (  172 => 49,  166 => 45,  161 => 42,  151 => 38,  147 => 37,  143 => 36,  138 => 34,  134 => 33,  130 => 32,  126 => 31,  123 => 30,  119 => 29,  106 => 18,  104 => 17,  96 => 12,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
                            ...
                            {% for reclamation in reclamations %}
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href=\"{{ path('app_reponse_show', {'id': reclamation.id}) }}\" class=\"btn btn-sm btn-primary mr-2\">Show response</a>
                                    </td>
                                </tr>
                            {% endfor %}
                        </tbody>
...
{% endblock %}
", "reclamation/index.html.twig", "C:\\Users\\khaled\\Desktop\\PiDev-DevMinds2024-master\\PiDev-DevMinds2024-master\\templates\\reclamation\\index.html.twig");
    }
}
